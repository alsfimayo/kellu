...
export const ROLE_ROUTES = {
  ...
  update: createRoute({
    ...
    responses: {
      [HttpStatusCodes.OK]: jsonContent(zodResponseSchema(RoleResponseSchema), "OK"),
      [HttpStatusCodes.BAD_REQUEST]: jsonContent(zodResponseSchema(), "Invalid permissions or system role"),
      [HttpStatusCodes.NOT_FOUND]: jsonContent(zodResponseSchema(), "Role not found"),
      [HttpStatusCodes.UNAUTHORIZED]: jsonContent(zodResponseSchema(), "Unauthorized"),
      [HttpStatusCodes.INTERNAL_SERVER_ERROR]: jsonContent(zodResponseSchema(), "Server error"),
    },
  ...
  delete: createRoute({
    ...
    responses: {
      ...
      [HttpStatusCodes.BAD_REQUEST]: jsonContent(zodResponseSchema(), "Role is in use or is a system role"),
      [HttpStatusCodes.NOT_FOUND]: jsonContent(zodResponseSchema(), "Role not found"),
      [HttpStatusCodes.UNAUTHORIZED]: jsonContent(zodResponseSchema(), "Unauthorized"),
      [HttpStatusCodes.INTERNAL_SERVER_ERROR]: jsonContent(zodResponseSchema(), "Server error"),
    },
